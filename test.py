...
def parse_args():
    ...
    # dataset parameters
    parser.add_argument("--coco-path", type=str, required=True)#D:\SFDSA\Salience-DETR-main\datasets\coco6900xin
    parser.add_argument("--subset", type=str, default="val")
    parser.add_argument("--workers", type=int, default=2)

    # choose model to inference on dataset or result_file
    parser.add_argument("--model-config", type=str, default=None)
    parser.add_argument("--checkpoint", type=str, default=r'D:\SFDSA\Salience-DETR-main\checkpoints\salience_detr_resnet50_800_1333-px\train\2024-11-23-13_38_12-d\best_ap.pth')
    parser.add_argument("--result", type=str, default=r'')
...
def test_on_dataset():
    ...
    dataset = CocoDetection(
        ...
        ann_file=f"{args.coco_path}/instances_{args.subset}2017.json",
    ...
    if args.model_config is None or args.show_dir and accelerator.is_main_process:
        coco_dt = loadRes(COCO(f"{args.coco_path}/instances_{args.subset}2017.json"), args.result)
