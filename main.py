...
# torch.utils.data.DataLoaderpin_memory=True
# #windows:
...
# import subprocess
#
# command = "CUDA_VISIBLE_DEVICES=0,1 accelerate launch main.py"
...
def train():
    ...
    # Output model struct CHANGE HERE
    with open('model_struct.txt', 'w') as f:
        ...
        print(f"Parameters required_grad count: {sum_param}", file=f)
    f.close()
